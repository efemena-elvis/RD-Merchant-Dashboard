...
.overview-balance-column {
  @apply flex flex-col justify-between items-start gap-y-4;

  .balance-type {
    @apply text-[13.25px] text-grey-700/85;
  }
  ...
  .balance-base {
    ...
    &-info {
      ...
      .balance-amount {
        @apply text-[19.5px] font-semibold text-teal-800;
      }

      .balance-stat {
        @apply text-xs text-grey-600/85;
    ...
    .balance-graph {
      @apply absolute right-0 w-[85px] h-auto border-b border-grey-300/80;
    }
  }
}
</style>
