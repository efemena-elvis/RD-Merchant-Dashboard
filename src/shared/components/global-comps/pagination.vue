...
.pagination-row {
  ...
  .right {
    ...
    .nav {
      @apply h-10 w-[78px] flex justify-center items-center gap-x-1 rounded-lg cursor-pointer text-grey-500 transition duration-300 ease-in-out hover:text-green-600 disabled:cursor-not-allowed disabled:text-grey-400 first-of-type:pl-3.5 last-of-type:pr-3.5;
