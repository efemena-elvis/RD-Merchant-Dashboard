  ...
  <div class="layout-wrapper">
    <div class="submitted-layout transition duration-300 ease-in-out">
      <template v-if="businesActivated">
        ...
        <div class="icon-img">
          <img
            :src="renderImg('file-funnel.png')"
            alt="emptyComplianceSection"
          />
        </div>
...
import SkeletonSuccessCompliance from "@/modules/compliance/components/skeleton-success-compliance.vue";
