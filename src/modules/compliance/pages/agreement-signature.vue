      ...
      <div class="merchant-agreement-block">
        <div class="agreement-copy-section">
          ...
          <div class="decription-text">
            <span>The Redstone's Merchant Agreement</span> is a contract between
            you and Redstone, outlining the responsibilities of both parties. It
            also emphasizes specific risks and conditions associated with using
            our Services, which you should review thoroughly. By using this
            website or any of our Services, you agree to the terms of this
            Agreement.
          </div>
        </div>
