<template>
  <ComplianceDisplayBlock
    ...
    @onContinueClick="router.push({ name: 'RedstoneRegistrationInformation' })"
  >
    <div class="content-block">
      <UploadGuidelines
        title="Please upload a proof of address that:"
        :guidelines="[
          'Confirm your address at: <br/> 9a, Ademola Oshinowo, Ketu-ikosi, Lagos, Nigeria',
      ...
      <div class="mb-14">
        <FileUploadInput showSkip skipRoute="RedstoneRegistrationInformation" />
      </div>
    </div>
  </ComplianceDisplayBlock>
</template>
