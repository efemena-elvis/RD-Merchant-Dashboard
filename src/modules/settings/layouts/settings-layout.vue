  ...
  <div class="settings-layout">
    <div class="settings-sidebar">
      <div class="sidebar-nav-items">
        <router-link
          v-for="(route, index) in settingsSidebarRoutes"
          :key="index"
...
import { settingsSidebarRoutes } from "@/shared/constants/sidebar-routes";
...
.settings-layout {
  ...
  .settings-sidebar {
    ...
    .sidebar-nav-items {
      @apply flex flex-col justify-start items-start gap-y-3.5 border-l border-grey-200/80;
